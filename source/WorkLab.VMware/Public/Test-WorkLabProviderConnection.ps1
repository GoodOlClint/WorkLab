function Test-WorkLabProviderConnection {
    <#
    .SYNOPSIS
        VMware provider: health check; returns capability flags. (Phase 0 stub.)
    ...
    throw [System.NotImplementedException]::new(
        "Test-WorkLabProviderConnection is not implemented for the VMware provider yet (Phase 8). " +
