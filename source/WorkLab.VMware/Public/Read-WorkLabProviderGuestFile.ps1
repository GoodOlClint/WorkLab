function Read-WorkLabProviderGuestFile {
    <#
    .SYNOPSIS
        VMware provider: read a file from the guest via the guest agent. (Phase 0 stub.)
    ...
    throw [System.NotImplementedException]::new(
        "Read-WorkLabProviderGuestFile is not implemented for the VMware provider yet (Phase 8). " +
