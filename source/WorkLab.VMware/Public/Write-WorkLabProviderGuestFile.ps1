function Write-WorkLabProviderGuestFile {
    <#
    .SYNOPSIS
        VMware provider: push a file to the guest via the guest agent. (Phase 0 stub.)

    .DESCRIPTION
        Part of the WorkLab provider contract guest channel
        (see docs/PROVIDERS.md). Not implemented in Phase 0 for the
        VMware provider (Phase 8). Real signature accepts
    ...
    .EXAMPLE
        Write-WorkLabProviderGuestFile -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Write-WorkLabProviderGuestFile is not implemented for the VMware provider yet (Phase 8). " +
