function Test-WorkLabProviderGuestAgent {
    <#
    .SYNOPSIS
        VMware provider: is the guest agent up + responding. (Phase 0 stub.)
    ...
    .EXAMPLE
        Test-WorkLabProviderGuestAgent -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Test-WorkLabProviderGuestAgent is not implemented for the VMware provider yet (Phase 8). " +
