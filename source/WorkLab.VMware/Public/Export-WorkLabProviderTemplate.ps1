function Export-WorkLabProviderTemplate {
    <#
    .SYNOPSIS
        VMware provider: sysprep + capture a VM as a named template. (Phase 0 stub.)
    ...
    throw [System.NotImplementedException]::new(
        "Export-WorkLabProviderTemplate is not implemented for the VMware provider yet (Phase 8). " +
