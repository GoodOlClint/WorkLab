function Invoke-WorkLabProviderGuestCommand {
    <#
    .SYNOPSIS
        VMware provider: run a command via the guest agent. (Phase 0 stub.)
    ...
    .EXAMPLE
        Invoke-WorkLabProviderGuestCommand -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Invoke-WorkLabProviderGuestCommand is not implemented for the VMware provider yet (Phase 8). " +
