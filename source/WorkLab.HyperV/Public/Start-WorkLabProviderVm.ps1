function Start-WorkLabProviderVm {
    <#
    .SYNOPSIS
        Hyper-V provider: start a VM. (Phase 0 stub.)
    ...
    .EXAMPLE
        Start-WorkLabProviderVm -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Start-WorkLabProviderVm is not implemented for the Hyper-V provider yet (Phase 7). " +
