function Write-WorkLabProviderGuestFile {
    <#
    .SYNOPSIS
        Hyper-V provider: push a file to the guest via the guest agent. (Phase 0 stub.)
    ...
    throw [System.NotImplementedException]::new(
        "Write-WorkLabProviderGuestFile is not implemented for the Hyper-V provider yet (Phase 7). " +
