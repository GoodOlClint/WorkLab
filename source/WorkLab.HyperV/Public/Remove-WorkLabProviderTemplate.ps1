function Remove-WorkLabProviderTemplate {
    <#
    .SYNOPSIS
        Hyper-V provider: remove a template. (Phase 0 stub.)
    ...
    .EXAMPLE
        Remove-WorkLabProviderTemplate -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Remove-WorkLabProviderTemplate is not implemented for the Hyper-V provider yet (Phase 7). " +
