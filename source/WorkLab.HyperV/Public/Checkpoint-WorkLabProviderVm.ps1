function Checkpoint-WorkLabProviderVm {
    <#
    .SYNOPSIS
        Hyper-V provider: snapshot a VM. (Phase 0 stub.)
    ...
    .EXAMPLE
        Checkpoint-WorkLabProviderVm -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Checkpoint-WorkLabProviderVm is not implemented for the Hyper-V provider yet (Phase 7). " +
