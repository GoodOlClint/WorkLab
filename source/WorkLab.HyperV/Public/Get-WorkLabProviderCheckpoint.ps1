function Get-WorkLabProviderCheckpoint {
    <#
    .SYNOPSIS
        Hyper-V provider: list VM snapshots. (Phase 0 stub.)
    ...
    .EXAMPLE
        Get-WorkLabProviderCheckpoint -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Get-WorkLabProviderCheckpoint is not implemented for the Hyper-V provider yet (Phase 7). " +
