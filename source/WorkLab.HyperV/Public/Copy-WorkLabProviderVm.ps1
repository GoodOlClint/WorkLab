function Copy-WorkLabProviderVm {
    <#
    .SYNOPSIS
        Hyper-V provider: clone a VM from a template. (Phase 0 stub.)
    ...
    .EXAMPLE
        Copy-WorkLabProviderVm -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Copy-WorkLabProviderVm is not implemented for the Hyper-V provider yet (Phase 7). " +
