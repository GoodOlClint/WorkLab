function Get-WorkLabProviderIso {
    <#
    .SYNOPSIS
        Hyper-V provider: list registered ISOs. (Phase 0 stub.)
    ...
    .EXAMPLE
        Get-WorkLabProviderIso -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Get-WorkLabProviderIso is not implemented for the Hyper-V provider yet (Phase 7). " +
