function Get-WorkLabProviderNetwork {
    <#
    .SYNOPSIS
        Hyper-V provider: get the per-lab network. (Phase 0 stub.)
    ...
    .EXAMPLE
        Get-WorkLabProviderNetwork -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Get-WorkLabProviderNetwork is not implemented for the Hyper-V provider yet (Phase 7). " +
