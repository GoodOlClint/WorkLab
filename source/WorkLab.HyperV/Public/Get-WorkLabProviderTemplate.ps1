function Get-WorkLabProviderTemplate {
    <#
    .SYNOPSIS
        Hyper-V provider: list templates. (Phase 0 stub.)
    ...
    .EXAMPLE
        Get-WorkLabProviderTemplate -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Get-WorkLabProviderTemplate is not implemented for the Hyper-V provider yet (Phase 7). " +
