function Restore-WorkLabProviderVm {
    <#
    .SYNOPSIS
        Hyper-V provider: restore a VM snapshot. (Phase 0 stub.)
    ...
    .EXAMPLE
        Restore-WorkLabProviderVm -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Restore-WorkLabProviderVm is not implemented for the Hyper-V provider yet (Phase 7). " +
