function Remove-WorkLabProviderCheckpoint {
    <#
    .SYNOPSIS
        Hyper-V provider: remove a VM snapshot. (Phase 0 stub.)
    ...
    .EXAMPLE
        Remove-WorkLabProviderCheckpoint -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Remove-WorkLabProviderCheckpoint is not implemented for the Hyper-V provider yet (Phase 7). " +
