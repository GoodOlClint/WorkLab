function Export-WorkLabProviderTemplate {
    <#
    .SYNOPSIS
        Hyper-V provider: sysprep + capture a VM as a named template. (Phase 0 stub.)
    ...
    .EXAMPLE
        Export-WorkLabProviderTemplate -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Export-WorkLabProviderTemplate is not implemented for the Hyper-V provider yet (Phase 7). " +
