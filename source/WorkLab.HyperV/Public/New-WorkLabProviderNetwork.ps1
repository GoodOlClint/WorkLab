function New-WorkLabProviderNetwork {
    <#
    .SYNOPSIS
        Hyper-V provider: create the per-lab network (VLAN/bridge). (Phase 0 stub.)
    ...
    .EXAMPLE
        New-WorkLabProviderNetwork -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "New-WorkLabProviderNetwork is not implemented for the Hyper-V provider yet (Phase 7). " +
