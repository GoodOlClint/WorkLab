function Remove-WorkLabProviderNetwork {
    <#
    .SYNOPSIS
        Hyper-V provider: remove the per-lab network. (Phase 0 stub.)
    ...
    .EXAMPLE
        Remove-WorkLabProviderNetwork -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Remove-WorkLabProviderNetwork is not implemented for the Hyper-V provider yet (Phase 7). " +
