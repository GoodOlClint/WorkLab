function Invoke-WorkLabProviderGuestCommand {
    <#
    .SYNOPSIS
        Hyper-V provider: run a command via the guest agent. (Phase 0 stub.)
    ...
    throw [System.NotImplementedException]::new(
        "Invoke-WorkLabProviderGuestCommand is not implemented for the Hyper-V provider yet (Phase 7). " +
