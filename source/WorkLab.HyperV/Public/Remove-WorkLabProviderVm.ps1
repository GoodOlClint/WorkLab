function Remove-WorkLabProviderVm {
    <#
    .SYNOPSIS
        Hyper-V provider: remove a VM. (Phase 0 stub.)
    ...
    .EXAMPLE
        Remove-WorkLabProviderVm -Context $ctx
    ...
    throw [System.NotImplementedException]::new(
        "Remove-WorkLabProviderVm is not implemented for the Hyper-V provider yet (Phase 7). " +
